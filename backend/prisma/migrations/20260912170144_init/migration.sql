...
-- CreateIndex
CREATE INDEX "Task_assigneeId_priority_dueDate_idx" ON "Task"("assigneeId", "priority", "dueDate");
...
-- AddForeignKey
ALTER TABLE "TaskStatusEvent" ADD CONSTRAINT "TaskStatusEvent_changedById_fkey" FOREIGN KEY ("changedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
